...
namespace coliks.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public StaffsController(ColiksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom")] Staffs staffs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom")] Staffs staffs)
        {
            if (id != staffs.Id)
            {
                return NotFound();
